...
alllabels = [
    'AVX4', 'AVZ4', 'BVX4', 'BVZ4', 'BWY4', 'CVX4', 'CVZ4', 'CWY4', 'AVY4',
    'AWX4', 'AWZ4', 'BVY4', 'BWX4', 'BWZ4', 'CVY4', 'CWX4', 'CWZ4', 'AVX7',
    'AVZ7', 'BVX7', 'BWY7', 'CVY7', 'AWY4', 'AWY7', 'CWX7', 'CWZ7', 'AVY7',
    'BVZ7', 'AWX7', 'AWZ7', 'BWX7', 'BWZ7', 'CVX7', 'CWY7', 'DVX4', 'DVZ7',
    'DVX7', 'DVY7', 'DWY7', 'DWZ7'
]
...
#ax.set_xlabel('Meander Amplitude', fontsize=16)
#ax.set_ylabel('Area innudated', fontsize=16)

cbar = plt.colorbar(scat, ticks=[300,600,900,1200])
