...
for i in `seq $startfrom $timesteps`
do
...
cp kubo_pretty_iso.net temp2.net
cp kubo_pretty_iso.cfg kubo_pretty_script.cfg
...
echo -e "$currentdate ran kubo_pretty.net " >> status.txt
