...
t = 4 
ALLOCATE(area(RMAX, ZMAX))

!DO I = 1,length1 
!   J = EP_P(I,2,t)/2
!   bottom = tand(M)*2*(400-J)+20
M=20 


DO I=1,length1!
     IF (EP_P(I,1,t)<max_dilute .AND. EP_P(I,1,t)>min_dense) THEN
     !IF (EP_P(I,3,t) .EQ. bottom) THEN 
       print*, EP_P(I,2,t), EP_P(I,4,t), EP_P(I,1,t)
