...
INTEGER::I,J,K,IMAX,JMAX,ZMAX,timesteps,t, Z, io2, io1, io3 
REAL :: M, D, DX, DY
DOUBLE PRECISION, ALLOCATABLE :: EPG(:,:), TG(:,:), UG(:,:)
DOUBLE PRECISION :: PART  
DOUBLE PRECISION :: AVGTDILUTE, AVGTMED, AVGTDENSE, TDENSE, TMED, TDILUTE, TTOPO
DOUBLE PRECISION :: AVGUDILUTE, AVGUMED, AVGUDENSE, UDENSE, UMED, UDILUTE, UTOPO
...
OPEN(400, FILE= 'UG', FORM = 'FORMATTED')
OPEN(301, file= 'avgT1', form= 'formatted')
OPEN(302, FILE= 'avgT2', FORM = 'FORMATTED')
OPEN(303, file = 'avgT3', form = 'formatted')
OPEN(401, file= 'avgU1', form= 'formatted')
OPEN(402, FILE= 'avgU2', FORM = 'FORMATTED')
OPEN(403, file = 'avgU3', form = 'formatted')
...
AVGUDILUTE = (UDILUTE-UTOPO)/(SUM1-SUM4)
AVGUMED = (UMED-UTOPO)/(SUM2-SUM4)
AVGUDENSE = (UDENSE-UTOPO)/(SUM3-SUM4)

WRITE(301, 802) AVGTDILUTE 
WRITE(302, 802) AVGTMED 
WRITE(303, 802) AVGTDENSE

WRITE(401, 802) AVGUDILUTE
WRITE(402, 802) AVGUMED
WRITE(403, 802) AVGUDENSE
